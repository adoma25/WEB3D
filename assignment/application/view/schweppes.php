    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item active" href="./index.php?schweppes"><?php echo $data[2][2]['brandTitle'] ?></a>
        </div>
      </li>
    </ul>
  </div>
...
<div class="container main_contents">
  <div class="container">
            ...
            <div class="card-body d-flex justify-content-center">
              ...
              <div>
                <x3d width='1200px' height='600px'>
                  <scene>
                    <inline url="./application/view/assets/x3d/Shweppes.x3d" namespacename='nikmok'> </inline>
                  </scene>
                </x3d>
              </div>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-interval="false">
          ...
          <div class="carousel-inner" >
            <div class="carousel-item active">
              <img src="../assignment/application/view/assets/renderedImages/schweppes/schweppesIndian.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
              </div>
            </div>
            <div class="carousel-item">
              <img src="../assignment/application/view/assets/renderedImages/schweppes/schweppesIndianMain.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="../assignment/application/view/assets/renderedImages/schweppes/schweppesSlimeline.png" class="d-block w-100" alt="...">
            </div>
          </div>
          <a class="carousel-control-prev"  onclick="changeTexture('../textures/shweppes/schweppesIndianTonicWater.png');" href="#carouselExampleFade" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next"  onclick="changeTexture('../textures/shweppes/schweppesSlimelineTonicWater.png');" href="#carouselExampleFade" role="button" data-slide="next">
    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          <h2 class="card-title"><?php echo $data[2][2]['brandTitle'] ?></h2>
          <h3 class="card-title"><?php echo $data[2][2]['brandSubtitle'] ?></h3>
          <p class="card-text"><?php echo $data[2][2]['brandDescription'] ?></p>
        </div>
      </div>
    </div>
    </div>
